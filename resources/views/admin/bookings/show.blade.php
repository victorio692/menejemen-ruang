                ...
                <div class="card shadow-sm border-0 rounded-3 mb-3">
                    ...
                    <div class="card-body">
                        <p class="mb-2">
                            ...
                            <p class="fw-semibold">{{ $booking->approved_by }}</p>
                        </p>
                        <p class="mb-0">
                            <label class="form-label text-muted small fw-semibold">Tanggal & Waktu</label>
                            <p class="fw-semibold">{{ \Carbon\Carbon::parse($booking->approved_at)->format('d M Y H:i') }}</p>
                        </p>
                    </div>
                </div>
            @endif
        ...
        <div class="row mt-4">
            <div class="col-lg-8">
                <div class="d-grid gap-2 gap-md-3 d-md-flex">
                    <form action="{{ route('admin.booking.approve', $booking->id) }}" method="POST" style="flex: 1;">
                        @csrf
