...
<body>
    ...
    <div class="main-wrapper @if(!Auth::check() || (Auth::check() && Auth::user()->role !== 'admin' && Auth::user()->role !== 'petugas')) no-sidebar @endif">
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-section">
                ...
                @if(Auth::user()->role === 'admin')
                <a href="{{ route('admin.petugas') }}" class="nav-item {{ request()->routeIs('admin.petugas*') ? 'active' : '' }}">
                    <span class="nav-icon">👥</span>
                ...
                <a href="{{ route('admin.jadwal_reguler') }}" class="nav-item {{ request()->routeIs('admin.jadwal_reguler') ? 'active' : '' }}">
                    <span class="nav-icon">📅</span>
                    <span>Jadwal Reguler</span>
                </a>
                <a href="{{ route('admin.jadwal_reguler.mingguan') }}" class="nav-item {{ request()->routeIs('admin.jadwal_reguler.mingguan*') ? 'active' : '' }}">
                    <span class="nav-icon">📊</span>
                    <span>Jadwal Mingguan</span>
                </a>
                @elseif(Auth::user()->role === 'petugas')
                <a href="{{ route('petugas.rooms') }}" class="nav-item {{ request()->routeIs('petugas.rooms*') ? 'active' : '' }}">
                    <span class="nav-icon">🏢</span>
                    <span>Manajemen Ruangan</span>
                </a>
                <a href="{{ route('petugas.bookings') }}" class="nav-item {{ request()->routeIs('petugas.bookings*') ? 'active' : '' }}">
                    <span class="nav-icon">📋</span>
                    <span>Manajemen Booking</span>
                </a>
                <a href="{{ route('petugas.jadwal_reguler') }}" class="nav-item {{ request()->routeIs('petugas.jadwal_reguler') ? 'active' : '' }}">
                    <span class="nav-icon">📅</span>
                    <span>Jadwal Reguler</span>
                </a>
                <a href="{{ route('petugas.jadwal_reguler.mingguan') }}" class="nav-item {{ request()->routeIs('petugas.jadwal_reguler.mingguan*') ? 'active' : '' }}">
                    <span class="nav-icon">📊</span>
                    <span>Jadwal Mingguan</span>
                </a>
                @endif
            ...
            <nav class="nav-section">
                ...
                @elseif(Auth::user()->role === 'petugas')
                <a href="{{ route('petugas.reports.index') }}" class="nav-item {{ request()->routeIs('petugas.reports.*') ? 'active' : '' }}">
                    <span class="nav-icon">📊</span>
                    <span>Generate Laporan</span>
                </a>
                @endif
        ...
        <nav class="navbar-custom">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <h5 class="navbar-brand mb-0">@yield('title', 'Dashboard')</h5>
                </div>
    ...
    <script>
        ...
        function refreshCSRFToken() {
            const refreshUrl = '{{ route("api.refresh-csrf") }}';
        ...
        function showSessionExpiredMessage() {
            ...
            warning.innerHTML = `
                ...
                <button type="button" class="btn btn-sm btn-warning" onclick="window.location.href='{{ route("login") }}';">
                    Go ke Login
                </button>
