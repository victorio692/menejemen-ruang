...
<?php $__env->startSection('title', 'Generate Laporan Booking'); ?>
            ...
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-body">
                    ...
                    <?php if(auth()->user()->role === 'admin'): ?>
                        <?php echo e(route('admin.reports.generate')); ?>

                    <?php elseif(auth()->user()->role === 'petugas'): ?>
                        <?php echo e(route('petugas.reports.generate')); ?>

                    <?php else: ?>
                        <?php echo e(route('reports.generate')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\menejemen-ruang\resources\views/reports/index.blade.php ENDPATH**/ ?>