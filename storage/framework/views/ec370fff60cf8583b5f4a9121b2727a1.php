<?php $__env->startSection('title', 'Buat Booking Baru'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-4 py-4">
        ...
        <div class="card shadow-sm border-0 rounded-3 p-4">
            <form action="<?php echo e(route('user.booking.store')); ?>" method="POST" id="bookingForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" name="selected_sessions" id="selectedSessions" value="<?php echo e(old('selected_sessions')); ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="purpose" id="purpose" class="form-control" placeholder="Tujuan booking" rows="3" required><?php echo e(old('purpose')); ?></textarea>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\menejemen-ruang\resources\views/user/booking/create.blade.php ENDPATH**/ ?>