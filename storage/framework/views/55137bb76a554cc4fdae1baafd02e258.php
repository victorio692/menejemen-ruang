                    ...
                    <div class="row mb-4">
                        <div class="col-12 col-md-6">
                            ...
                            <p class="fw-semibold fs-6 mb-3">
                                ...
                                <?php echo e($booking->user->name ?? 'Pengguna Tidak Ditemukan'); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <p class="fw-semibold fs-6 mb-3">
                                ...
                                <?php echo e($booking->room->capacity ?? '-'); ?> orang
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <p class="fw-semibold fs-6 mb-2">
                                ...
                                <?php echo e(\Carbon\Carbon::parse($booking->end_time)->format('d M Y')); ?>
                ...
                <div class="alert alert-danger shadow-sm border-0 rounded-3" role="alert">
                    <div class="d-flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="mb-0"><?php echo e($booking->rejection_reason); ?></p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <div class="col-lg-4">
                    ...
                    <div class="timeline">
                        ...
                        <?php if($booking->approved_at): ?>
                            <div class="timeline-item">
                                <div class="timeline-marker <?php echo e($booking->status == 'disetujui' ? 'bg-success' : 'bg-danger'); ?>">
                                    <i class="bi <?php echo e($booking->status == 'disetujui' ? 'bi-check-circle' : 'bi-x-circle'); ?> text-white"></i>
                                </div>
                                <div class="timeline-content">
                                    <p class="fw-semibold mb-1">
                                        <?php echo e($booking->status == 'disetujui' ? 'Disetujui' : 'Ditolak'); ?>

                                    </p>
                                    <small class="text-muted">
                                        <?php echo e(\Carbon\Carbon::parse($booking->approved_at)->format('d M Y H:i')); ?>
            ...
            <?php if($booking->approved_by): ?>
                <div class="card shadow-sm border-0 rounded-3 mb-3">
                    ...
                    <div class="card-body">
                        <p class="mb-2">
                            <label class="form-label text-muted small fw-semibold">Diproses Oleh</label>
                            <p class="fw-semibold"><?php echo e($booking->approved_by); ?></p>
                        </p>
                        <p class="mb-0">
                            <label class="form-label text-muted small fw-semibold">Tanggal & Waktu</label>
                            <p class="fw-semibold"><?php echo e(\Carbon\Carbon::parse($booking->approved_at)->format('d M Y H:i')); ?></p>
                        </p>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <!-- Room Description -->
            <?php if($booking->room && $booking->room->description): ?>
                <div class="card shadow-sm border-0 rounded-3">
                    ...
                    <div class="card-body">
                        <p class="text-muted small mb-0">
                            <?php echo e($booking->room->description); ?>
        ...
        <div class="row mt-4">
            <div class="col-lg-8">
                <div class="d-grid gap-2 gap-md-3 d-md-flex">
                    <form action="<?php echo e(route('admin.booking.approve', $booking->id)); ?>" method="POST" style="flex: 1;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\menejemen-ruang\resources\views/admin/bookings/show.blade.php ENDPATH**/ ?>